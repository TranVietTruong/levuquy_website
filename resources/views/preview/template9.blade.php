    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-centered page-scroll">
                <h1>V<small>&</small>H</h1>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbar-brand-centered">
            <ul class="nav navbar-nav page-scroll">
                <li><a href="#about">Cặp đôi</a></li>
                <li><a href="#story">Chuyện tình yêu</a></li>
                <li><a href="#event">Sự kiện cưới</a></li>
                <li><a href="#rsvp">Sổ Lưu Bút</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right page-scroll">
                <li><a href="#attendants">Phù Dâu &amp; Phù Rể</a></li>
                <li><a href="#gallery">Album Hình Cưới</a></li>
                <li><a href="javascript:void(0)" class="buttonDonate">Mừng cưới</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<section id="intro" class="container-fluid">
    <div class="photowall">
        ...
        <div class="col-md-4 margin1">
            <img src="https://cdn.biihappy.com/ziiweb/default/template/6174ee94ff1ef271cb2d8bc5/89a39b9c0682fb215c909be621ff4e4d.jpg" alt="" class="rotate1 img-photo img-responsive">
        </div>
        <!-- ẢNH PHẢI -->
        <div class="col-md-4  col-md-offset-4">
            <img src="https://cdn.biihappy.com/ziiweb/default/template/6174ee94ff1ef271cb2d8bc5/e747b98e9542d598bf05efc1f037f01d.jpg" alt="" class="rotate2 img-photo img-responsive">
        </div>
    </div>
    <!-- ẢNH GIỮA -->
    <div class="main-picture col-md-6 col-centered" data-100="margin-top:0px;transform: rotate(4deg);" data-center-center="margin-top:50px;transform: rotate(-10deg);">
        <img src="https://cdn.biihappy.com/ziiweb/default/template/6174ee94ff1ef271cb2d8bc5/6e58c2de50e5c089c560c00cd091f24c.jpg" alt="" class="img-photo img-responsive">
    </div>
    <div class="intro-heading col-md-12 text-center" data-0="opacity:1;" data--100-start="transform:translatey(0%);" data-center-bottom="transform:translatey(30%);">
        <h1 class="margin1">Kiến Văn <span class="italic" style="margin-right:8px;"> & </span> Việt Hoài</h1>
        ...
        <div class="row">
            <div class="well col-md-10 col-md-offset-1 text-center">
                ...
                <div class="clock-grids">
                    <!-- NGÀY CƯỚI SỬA Ở ĐÂY -->
                    <div id="clock" data-date="2024-08-25" data-text-day="Ngày" data-text-hour="Giờ" data-text-minute="Phút" data-text-second="Giây"></div>
                </div>
...
<section id="about" class="">
    <div class="container">
        ...
        <div class="col-lg-5 col-lg-offset-1 col-md-6">
            <div class="img_couple"><img src="https://i.imgur.com/mvYC3tk.jpeg" alt="" class="img-responsive img-circle"/></div>
            <h4 class="text-ornament">Hoàng Kiến Văn</h4>
        ...
        <div class="col-lg-5 col-md-6 res-margin">
            <div class="img_couple"><img src="https://cdn.biihappy.com/ziiweb/default/website/59b631f29bfb9f7cd20437d27ddbe4db.jpeg" alt="" class="img-responsive img-circle"/></div>
            <h4 class="text-ornament">Ngô Việt Hoài</h4>
            <div class="parent-infos">
...
<section class="video-section p-t-0 p-b-0 text-white pt-0 pb-0" id="video">
    <div class="top-area" style="background: url(https://cdn.biihappy.com/ziiweb/default/template/6174ee94ff1ef271cb2d8bc5/751b8cda591e3805c5d74e08f43bba40.jpg) center center/cover no-repeat local;">
        ...
        <div class="video-btn"><a href="https://www.youtube.com/embed/lGUdD29BDMg" class="video-play-btn" data-type="iframe"><i class="fa fa-play"></i></a></div>
    </div>
</section>
<!-- END VIDEO CƯỚI -->
                ...
                <div class="col-md-6" id="bridemaids">
                    <div id="owl-attendants1 col-md-12" class="">
                        <div class="attendants-wrap col-md-12">
                            <div class="member">
                                <div class="wrap">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/fa1780c6fe429eff4f2d564d6fbaff98.jpeg" alt="" class="img-circle img-responsive">
                                    <div class="info">
                                        <h5 class="name">Lý Mạc Sầu</h5>
                        ...
                        <div class="attendants-wrap col-md-12">
                            <div class="member">
                                <div class="wrap">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/84729db4c190b37df0a2cdcedba3f9b2.jpeg" alt="" class="img-circle img-responsive">
                                    <div class="info">
                                        <h5 class="name">Phạm Ðoan Trang</h5>
                ...
                <div class="col-md-6" id="groomsman">
                    <div id="owl-attendants2 col-md-12" class="">
                        <div class="attendants-wrap col-md-12">
                            <div class="member">
                                <div class="wrap">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/0a6cfab9e637b586cec8724825f99d9e.jpeg" alt="" class="img-circle img-responsive">
                                    <div class="info">
                                        <h5 class="name">Trần Đức Minh</h5>
                                        <!--<h4 class="friend-birthday">12/02/1998</h4>-->
                        ...
                        <div class="attendants-wrap col-md-12">
                            <div class="member">
                                <div class="wrap">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/7411475c6f639d4457ef1ea26ce09ee2.jpeg" alt="" class="img-circle img-responsive">
                                    <div class="info">
                                        <h5 class="name">Hoàng Gia Bảo</h5>
                                        <!--<h4 class="friend-birthday">20/03/1997</h4>-->
...
<section
    ...
    style="background: url(https://cdn.biihappy.com/ziiweb/default/template/6174ee94ff1ef271cb2d8bc5/945a554c6af499a0db203d7569884be7.jpg) no-repeat;background-size: cover;background-position: center;">
...
<footer>
    <div class="container">
        <div class="col-md-12 text-center">
            <div class="logo_ft center-block">V<small>&</small>H</div>
