...
<div class="page-wrapper">
    <div class="preloader">
        <div class="vertical-centered-box">
            <div class="content">
                ...
                <img src="https://preview.iwedding.info/templates/template17/images/favicon.png" alt="">
            </div>
        </div>
    </div>

    <header id="header">
        <div class="wpo-site-header" style="position: absolute;">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-6 col-6">
                            <div class="navbar-header">
                                <a href="/"><h1 style="font-size:25px">{{$logo1}}<span class="main-color" ><i class="fa fa-heart" style="margin:5px 5px 5px 10px;" ></i></span>{{$logo2}}</h1></a>
                            </div>
                        </div>
                            ...
                            <div id="navbar" class="collapse navbar-collapse navigation-holder">
                                ...
                                <ul class="nav navbar-nav mb-2 mb-lg-0">
                                    <li class="menu-item-has-children">
                                        <a href="#">{{$custom['menu_home'] ?? 'Home' }}</a>
                                    </li>
                                    <li class="menu-item-has-children">
                                        <a href="#couple">{{$custom['menu_cap_doi'] ?? 'Cặp đôi' }}</a>
                                    </li>
                                    @if(isset($websiteInfo['cau_chuyen_tinh_yeu']) && $websiteInfo['cau_chuyen_tinh_yeu'])
                                    <li class="menu-item-has-children">
                                        <a href="#story">{{$custom['menu_cau_chuyen_tinh_yeu'] ?? 'Chuyện tình yêu' }}</a>
                                    </li>
                                    @endif

                                    @if(isset($websiteInfo['album']) && $websiteInfo['album'])
                                    <li class="menu-item-has-children">
                                        <a href="#gallery">{{$custom['menu_album_hinh_cuoi'] ?? 'Album Hình cưới' }}</a>
                                    </li>
                                    @endif

                                    @if(isset($websiteInfo['phu_dau_phu_re']) && $websiteInfo['phu_dau_phu_re'])
                                    <li class="menu-item-has-children">
                                        <a href="#people">{{$custom['menu_phu_dau_phu_re'] ?? 'Phù dâu & Phù rể' }}</a>
                                    </li>
                                    @endif

                                    @if(isset($websiteInfo['su_kien_cuoi']) && $websiteInfo['su_kien_cuoi'])
                                    <li class="menu-item-has-children">
                                        <a href="#event">{{$custom['menu_su_kien_cuoi'] ?? 'Sự kiện cưới' }}</a>
                                    </li>
                                    @endif
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slide-inner slide-bg-image" data-background="{{$custom['background_slider_1'] ?? 'https://cdn.biihappy.com/ziiweb/default/template/62ef3cdcf106ea77bb276cc5/9cc23c7deb01f71bc652a8599c55630b.jpg'}}">

                        <div class="container-fluid">
                            <div class="slide-content">
                                <div data-swiper-parallax="300" class="slide-title">
                                    <h2 class="font-size-slide-content font-family-title1">{{$couple['ten_chu_re_ngan_gon'] ?? 'Nguyễn Văn'}} <i class="ti-heart"></i> {{$couple['ten_co_dau_ngan_gon'] ?? 'Vũ Hoài'}}</h2>
                                </div>
                                <div data-swiper-parallax="400" class="slide-text">
                                    <p>We’re Getting Married!</p>
                                    <p>{{isset($websiteInfo['ngay_cuoi']) ? \Carbon\Carbon::parse($websiteInfo['ngay_cuoi'])->format('d-m-Y') : '04-04-2024'}}</p>
                                </div>
                                <div class="border-1"></div>
                                <div class="border-2"></div>
                                <div class="border-3"></div>
                                <div class="border-4"></div>
                                <div class="s-img-1"><img src="https://preview.iwedding.info/templates/template17/images/slider/shape3.png" alt=""></div>
                                <div class="s-img-2"><img src="https://preview.iwedding.info/templates/template17/images/slider/shape4.png" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="slide-inner slide-bg-image" data-background="{{$custom['background_slider_2'] ?? 'https://cdn.biihappy.com/ziiweb/default/template/62ef3cdcf106ea77bb276cc5/6bf9779158d43707a8d1d400c2da1e3d.jpg'}}">
                ...
                <div class="swiper-slide">
                    <div class="slide-inner slide-bg-image" data-background="{{$custom['background_slider_3'] ?? 'https://cdn.biihappy.com/ziiweb/default/template/62ef3cdcf106ea77bb276cc5/fb06bb8fc52cde617248ea27585517cb.jpg'}}">
            ...
            <div class="row">
                <div class="col col-xs-12">
                    <div class="clock-grids">
                        <div id="clock1" data-date="{{isset($websiteInfo['ngay_cuoi']) ? \Carbon\Carbon::parse($websiteInfo['ngay_cuoi'])->format('Y-m-d') : '2024-10-07'}}" data-text-day="Ngày" data-text-hour="Giờ" data-text-minute="Phút" data-text-second="Giây"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col col-xs-12">
                    <div class="couple-area clearfix">
                        <div class="text-grid bride">
                            ...
                            <h3 class="font-family-title2">{{$couple['ten_chu_re'] ?? 'Hoàng Nguyễn Văn'}}</h3>
                        ...
                        <div class="middle-couple-pic">
                            <img src="https://cdn.biihappy.com/ziiweb/default/template/62ef3cdcf106ea77bb276cc5/2766e60ccc5fca7a4c53b906494ce8e1.jpg" style="max-height:660px;" alt="">
                            <div class="frame-img"><img src="https://preview.iwedding.info/templates/template17/images/couple/shape.png" alt=""></div>
                        </div>
                        <div class="text-grid groom">
                            ...
                            <h3 class="font-family-title2" >{{$couple['ten_co_dau'] ?? 'Ngô Thúy Hoài'}}</h3>
                            <div class="parent-infos">
        ...
        <div class="row button-accessibilities animate-box" data-animate-effect="fadeInUp">
            <div class="col col-12">
                <div class="text-center">
                    <a href="javascript:void(0)" class="theme-btn buttonDonate album theme-btn-s3">
    ...
    <section class="wpo-video-section-s2">
        <div class="wpo-video-item">
            <div class="wpo-video-img" style="background: url({{$custom['background_video_cuoi'] ?? 'https://cdn.biihappy.com/ziiweb/default/template/62ef3cdcf106ea77bb276cc5/52b2cd61e1dbd0e9e4fdca88781ffb14.jpg'}}) center center/cover no-repeat local;min-height:500px">
                <h2 class="font-family-title2">Xem video cưới của chúng tôi</h2>
                <p style="color:#fff">{{$custom['text_video_cuoi'] ?? 'Tình yêu không làm cho thế giới quay tròn. Tình yêu là những gì làm cho chuyến đi đáng giá.'}}</p>
                <a href="https://www.youtube.com/embed/{{$websiteInfo->id_video_cuoi}}" class="video-btn" data-type="iframe"><i class="fi flaticon-play"></i></a>
            </div>
        </div>
    </section>
    @endif
        ...
        <div class="container">
            <div class="row">
                <div class="wpo-section-title-s2">
                    ...
                    <h2 class="font-family-title1">{{$custom['menu_cau_chuyen_tinh_yeu'] ?? 'Chuyện tình yêu' }}</h2>
                ...
                <div class="col col-xs-12">
                    <div class="story-timeline">
                                ...
                                <div class="row">
                                    <div class="col col-lg-6 col-12">
                                        <div class="img-holder right-align-text left-site">
                                            <img src="{{$loveStory['anh'] ?? 'https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/0f99c255f7aa7714d366ebde51c86d53.jpeg'}}" height="308" alt class="img img-responsive">
                                            <div class="story-shape-img">
                                                <img src="https://preview.iwedding.info/templates/template17/images/story/shape.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col col-lg-6 col-12 text-holder">
                                        ...
                                        <div class="story-text">
                                            <h3 class="font-family-title2">{{$loveStory['tieu_de'] ?? 'Bạn có tin vào tình yêu online không?'}}</h3>
                                            <span class="date">{{$loveStory['thoi_gian'] ?? 'December 12 2015'}}</span>
                        ...
                        <div class="row">
                            <div class="col col-lg-6 col-12">
                                <div class="img-holder right-align-text left-site">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/0f99c255f7aa7714d366ebde51c86d53.jpeg" height="308" alt class="img img-responsive">
                                    <div class="story-shape-img">
                                        <img src="https://preview.iwedding.info/templates/template17/images/story/shape.png" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="col col-lg-6 col-12 text-holder">
                                ...
                                <div class="story-text">
                                    <h3 class="font-family-title2">Bạn có tin vào tình yêu online không?</h3>
                        ...
                        <div class="row">
                            <div class="col col-lg-6 col-12">
                                <div class="story-text right-align-text">
                                    <h3 class="font-family-title2">Lời tỏ tình dễ thương^^</h3>
                            ...
                            <div class="col col-lg-6 col-12">
                                <div class="img-holder">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/be48dcf2522cd4ecfa7dab2dd4ebd3f9.jpeg" height="308" alt class="img img-responsive">
                                    <div class="story-shape-img">
                                        <img src="https://preview.iwedding.info/templates/template17/images/story/shape.png" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col col-lg-6 col-12">
                                <div class="img-holder right-align-text left-site">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/d2d08234dd0ece24828f396fa243a1ec.jpeg" height="308" alt class="img img-responsive">
                                    <div class="story-shape-img">
                                        <img src="https://preview.iwedding.info/templates/template17/images/story/shape.png" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="col col-lg-6 col-12 text-holder">
                                ...
                                <div class="story-text">
                                    <h3 class="font-family-title2">Phút giây cầu hôn</h3>
                        ...
                        <div class="row">
                            <div class="col col-lg-6 col-12">
                                <div class="story-text right-align-text">
                                    <h3 class="font-family-title2">Ngày lễ đính hôn</h3>
                            ...
                            <div class="col col-lg-6 col-12">
                                <div class="img-holder">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/d37c077f9ad6b076bc531b2d6ba44498.jpeg" height="308" alt class="img img-responsive">
                                    <div class="story-shape-img">
                                        <img src="https://preview.iwedding.info/templates/template17/images/story/shape.png" alt="">
                                    </div>
                                </div>
    ...
    <div class="wpo-cta-section-s3 " style="background: url({{$custom['background_adventure'] ?? 'https://cdn.biihappy.com/ziiweb/default/template/62ef3cdcf106ea77bb276cc5/244aba61c9bcb376bf986bf0b0b65571.jpg'}}) center center/cover no-repeat local;">
        <div class="conatiner-fluid">
            <div class="wpo-cta-item">
                <h2 class="font-family-title2">{{$custom['text_title_adventure'] ?? 'Adventure Begins'}}</h2>
                <p>{{$custom['text_adventure'] ?? 'Samsa was a travelling salesman and above it there hung a picture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame. It showed a lady fitted out with and fur boa who sat upright'}}</p>
            </div>
        </div>
    </div>
    ...
    <section class="wpo-portfolio-section section-padding" >
        <div class="_anchor" id="gallery"></div>
        <div class="container-fluid">
            <div class="row">
                <div class="wpo-section-title-s2">
                    <div class="section-title-simg">
            ...
            <div class="sortable-gallery container">
                <div class="row">
                    <div class="col-lg-12">
    ...
    @if(isset($websiteInfo['phu_dau_phu_re']) && $websiteInfo['phu_dau_phu_re'])
    <section class="blog-section section-padding section-bg-color" >
        <div class="_anchor" id="people"></div>
        <div class="container">
            <div class="row">
                <div class="wpo-section-title-s2">
                    <div class="section-title-simg">
            ...
            <div class="row">
                <div class="col-lg-6 col-xs-12">
                    <div class="blog-grids bridesmaid clearfix featured">
                        <div class="grid row mb-3">
                            <div class="col-lg-6 col-md-5">
                                <div class="wpo-team-img">
                                    <img src="{{$phudau['anh_phu_dau'] ?? 'https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/fa1780c6fe429eff4f2d564d6fbaff98.jpeg'}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-7">
                                <div class="wpo-team-text text-md-center1">
                                    <h3>{{$phudau['ten_phu_dau'] ?? ''}}</h3>
                                    <span>{{$phudau['gioi_thieu_phu_dau'] ?? ''}}</span>
                ...
                <div class="col-lg-6 col-xs-12">
                    <div class="blog-grids bridesmaid clearfix featured">
                        <div class="grid row mb-3">
                            <div class="col-lg-6 col-md-5">
                                <div class="wpo-team-img">
                                    <img src="{{$phudau['anh_phu_re'] ?? 'https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/0a6cfab9e637b586cec8724825f99d9e.jpeg'}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-7">
                                <div class="wpo-team-text text-md-center1">
                                    <h3>{{$phudau['ten_phu_re'] ?? ''}}</h3>
                                    <span>{{$phudau['gioi_thieu_phu_re'] ?? ''}}</span>
                                    <ul class="justify-content-md-start">
    ...
    <section class="wpo-event-section section-padding" >
        <div class="_anchor" id="event"></div>
        <div class="container">
            <div class="row">
                <div class="wpo-section-title-s2">
                    <div class="section-title-simg">
            ...
            <div class="wpo-event-wrap">
                <div class="row" style="justify-content:center">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="wpo-event-item">
                                    <div class="wpo-event-text">
                                        <h2 style="margin-bottom:10px">{{$event['ten_su_kien']}}</h2>
                                        ...
                                        <ul>
                                            <li>{{$event['thoi_gian']}}</li>
                                            <li style="min-height: 60px;">
                                                {{$event['dia_chi']}}
                                            </li>
                                            <li> <a  href="{{$event['map']}}" target="_blank">xem bản đồ </a></li>
                                        </ul>
                                    </div>
                                    <div class="event-shape-1">
                                        <img src="https://preview.iwedding.info/templates/template17/images/event-shape-1.png" alt="">
                                    </div>
                                    <div class="event-shape-2">
                                        <img src="https://preview.iwedding.info/templates/template17/images/event-shape-2.png" alt="">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="wpo-event-item">
                            <div class="wpo-event-text">
                                <h2 style="margin-bottom:10px">LỄ CƯỚI NHÀ NỮ</h2>
                                <div class="image-wrap">
                                ...
                                <ul>
                                    <li>07:30, 2023-02-10</li>
                                    <li style="min-height: 60px;">
                                        <span>TƯ GIA NHÀ NỮ - </span>
                                        123 Nguyễn Tất Thành, Hòa Phướng, Hải Châu, Đà Nẵng
                                    </li>
                                    <li> <a  href="https://www.google.com/maps/place/Da+Nang,+H%E1%BA%A3i+Ch%C3%A2u+District,+Da+Nang,+Vietnam/@16.0471659,108.1716864,13z/data=!3m1!4b1!4m5!3m4!1s0x314219c792252a13:0xfc14e3a044436487!8m2!3d16.0544068!4d108.2021667" target="_blank">xem bản đồ </a></li>
                                </ul>
                            </div>
                            <div class="event-shape-1">
                                <img src="https://preview.iwedding.info/templates/template17/images/event-shape-1.png" alt="">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="wpo-event-item">
                            <div class="wpo-event-text">
                                ...
                                <div class="image-wrap">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/8f7155409bf9ebdb9dffd7a38991aaa8.jpeg" alt="TIỆC CƯỚI NHÀ NỮ">
                                    <div class="dresscode-colors-wrap">

                                    </div>
                                </div>
                                <ul>
                                    <li>11:30, 2023-02-10</li>
                                    <li style="min-height: 60px;">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="wpo-event-item">
                            <div class="wpo-event-text">
                                <h2 style="margin-bottom:10px">LỄ CƯỚI NHÀ NAM</h2>
                                <div class="image-wrap">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="wpo-event-item">
                            <div class="wpo-event-text">
                                ...
                                <div class="image-wrap">
                                    <img src="https://cdn.biihappy.com/ziiweb/website/61990349db8f76231c132068/194d4b3c58f61adb4931a8a00a4fa019.jpeg" alt="TIỆC CƯỚI NHÀ NAM">
                                    <div class="dresscode-colors-wrap">
                                    </div>
                                </div>
                                <ul>
                                    <li>12:00, 2023-09-12</li>
                                    <li style="min-height: 60px;">
    ...
    @if(isset($websiteInfo['loi_cam_ta']) && $websiteInfo['loi_cam_ta'])
    <section class="wpo-contact-section section-padding section-bg-color">
        <div class="_anchor" id="rsvp"></div>
        <div id="wishes-section" class="container">
            <div class="row">
                <div class="wpo-section-title-s2">
                    <div class="section-title-simg">
                        <img src="https://preview.iwedding.info/templates/template17/images/section-title2.png" alt="">
...
<script type="text/javascript">
    const biicore = {template_id: '62ef3cfd4c248a18ec5a9b5a', templatePremium: (true), themeRoot:'https://preview.iwedding.info/templates/template18', webroot : 'https://preview.iwedding.info', coreSite: 'https://biihappy.com', webToken: '61990349db8f76231c132068', isPremium: ('1' === '1'), bgMusic: '{{$websiteInfo['nhac_website'] ?? "https://cdn.biihappy.com/ziiweb/wedding-musics/IDo-911.mp3"}}', alert: JSON.parse('{\"title\":\"L\\u1eddi c\\u1ea3m \\u01a1n t\\u1eeb D\\u00e2u & R\\u1ec3\",\"content\":\"Xin ch\\u00e2n th\\u00e0nh c\\u1ea3m \\u01a1n to\\u00e0n th\\u1ec3 m\\u1ecdi ng\\u01b0\\u1eddi \\u0111\\u00e3 g\\u1eedi l\\u1eddi ch\\u00fac cho v\\u1ee3 ch\\u1ed3ng ch\\u00fang em!\",\"timeout\":5000,\"status\":2,\"cancel_button_text\":\"\"}'), effect: JSON.parse('{\"type\":\"snow\"}'),isAutoPlay: ('1' === '1')};
</script>
<script src="https://preview.iwedding.info/templates/template17/js/jquery-plugin-collection.js?v=20241021"></script>
<script src="https://preview.iwedding.info/templates/template17/js/script.js?v=20241021"></script>
