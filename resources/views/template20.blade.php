...
<div class="wrapper">
    ...
    <section class="banner-section sub-title">
        <div data-aos="fade-up" class="bgm_area py-4" id="top">
            <p class="m-0 px-3 text-center">{{$cuople['ten_chu_re_ngan_gon'] ?? 'Kiến Văn'}} ♥ {{$couple['ten_co_dau_ngan_gon'] ?? 'Việt Hoài'}} sắp kết hôn.</p>
        </div>
        <div class="main_area">
            <div class="main_image_area">
                <div data-aos-duration="2000" data-aos="flip-left" class="">
                    <img src="{{$custom['anh_couple_1'] ?? 'https://cdn.biihappy.com/ziiweb/default/template/643d7a7706109e990f016274/adbe91da36d0b05ceedcfa265607ae76.jpg'}}">
                </div>
            ...
            <div data-aos="fade-up" class="wedding_area my-3 text-center">
                <div class="title pt-3 pb-2">
                    <span class="groom_name">{{$cuople['ten_chu_re_ngan_gon'] ?? 'Kiến Văn'}}</span>
                    <span>♥</span>
                    <span class="bride_name">{{$couple['ten_co_dau_ngan_gon'] ?? 'Việt Hoài'}}</span>
                </div>
                @if (isset($websiteInfo['ngay_cuoi']))
                    <p class="invitation_day mb-0">{{\Carbon\Carbon::parse($websiteInfo['ngay_cuoi'])->format('d/m/Y')}}</p>
                    <div class="day_area_inner pt-2">
                        {{\Carbon\Carbon::parse($websiteInfo['ngay_cuoi'])->day}}<img src="https://preview.iwedding.info/templates/template133/img/heart-icon.png">{{\Carbon\Carbon::parse($websiteInfo['ngay_cuoi'])->month}}
                    </div>
                @else
                <p class="invitation_day mb-0"> 04 / 04 / 2024</p>
                <div class="day_area_inner pt-2">
            ...
            <div class="w-100">
                <div class="text-center">
                    <p class="main_dday_name title py-1 px-3">
                        {{$couple['ten_chu_re_ngan_gon'] ?? 'Kiến Văn'}} ♥ {{$couple['ten_co_dau_ngan_gon'] ?? 'Việt Hoài'}}
                    </p>
                </div>
        ...
        <div class="wrap-invitation p-3">
            <div class="w-100">
                <div data-aos="fade-up" class="couple-img mb-5">
                    <img src="{{$custom['anh_couple_2'] ?? 'https://cdn.biihappy.com/ziiweb/default/template/643d7a7706109e990f016274/aed112329940c37e52ed5218b8302774.jpg'}}">
                </div>
                ...
                <div data-aos="fade-up"
                    ...
                    <p class="d-flex text justify-content-center">{{$couple['ten_chu_re_ngan_gon'] ?? 'Kiến Văn'}} <span>
                            <img src="https://preview.iwedding.info/templates/template133/img/heart-icon.png" alt="">
                            </span> {{$couple['ten_co_dau_ngan_gon'] ?? 'Việt Hoài'}}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="">
            <div data-aos="fade-up" class="wrap-img-title section-title text-center mb-5">
                ...
                <div class="wrap-img-medal">
                    <p class="text-center"> {{$couple['ten_chu_re'] ?? 'Kiến Văn'}} <span>♥</span> {{$couple['ten_co_dau'] ?? 'Việt Hoài'}}</p>
                </div>
            </div>
            ...
            <div id="section-comment">
                <div class="p-3 mb-3 " id="show-comments">
                    <div class="box-comment p-3 mb-3">
                        <p id="comment-detail" class="m-0"> {{ $loicamta['content'] ?? 'Cảm ơn các bạn đã có mặt để buổi lễ của chúng tôi được thêm phần long trọng'}}</p>
                    </div>
                </div>
            </div>
        </div>
