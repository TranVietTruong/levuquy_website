(function($) {
  ...
  if ($("#wish-form").length) {
    $("#wish-form").validate({
      ...
      messages: {
        name: {
          required: '<span style="color:red;">Vui lĂ²ng nháº­p tĂªn cá»§a báº¡n.<span>',
          minlength: '<span style="color:red;">TĂªn pháº£i lá»›n hÆ¡n 5 kĂ½ tá»±.<span>',
        },
        content: {
          required: '<span style="color:red;">Vui lĂ²ng nháº­p lá»i chĂºc.<span>',
          minlength: '<span style="color:red;">Lá»i chĂºc pháº£i lá»›n hÆ¡n 10 kĂ½ tá»±.<span>',
        },
        email: {
          email: '<span style="color:red;">Äá»‹a chá»‰ email khĂ´ng há»£p lá»‡.<span>'
        }
      },
