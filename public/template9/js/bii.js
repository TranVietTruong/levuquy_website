...
if(biicore.bgMusic){
  ...
  document.write(`
	...
	<div class="bii-player">
		<div onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Click vào đây để nghe bài hát của cô dâu và chủ rể bạn nhé</div></div>
